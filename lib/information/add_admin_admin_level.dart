...
import 'package:sub_admin_panel/dashboard/Admin%20Panel%20Permissions/Access%202.dart';
import '../methods/common_methods.dart';
import '../widgets/loading_dialog.dart';
import 'package:flutter/services.dart';


class Add_Admin_Admin_Level extends StatefulWidget {
  const Add_Admin_Admin_Level({Key? key}) : super(key: key);

  @override
  State<Add_Admin_Admin_Level> createState() => _Add_Admin_Admin_LevelState();
}
...
class _Add_Admin_Admin_LevelState extends State<Add_Admin_Admin_Level> {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (c) => Admin_Panel_Access_2()),
                        );
                      },
                    ),
                  ],
                              ...
                              Column(
                                children: [
                                  RadioListTile<String>(
                                    title: Text(
                                      "Manage Admins (Add & Delete Admins)",
                                  ...
                                  RadioListTile<String>(
                                    title: Text(
                                      "Manage Sub Admins (Add & Delete Sub Admins)",
                                      style: TextStyle(fontSize: 14),
                                    ),
                                    value: "Access #3",
                                    groupValue: selectedAccess,

...
import 'package:sub_admin_panel/dashboard/Admin%20Panel%20Permissions/Access%203.dart';
import 'package:sub_admin_panel/dashboard/Admin%20Panel%20Permissions/Super_Admin_Panel.dart';
import '../methods/common_methods.dart';
import '../widgets/loading_dialog.dart';
import 'package:flutter/services.dart';


class Add_Sub_Admin_Admin_Level extends StatefulWidget {
  const Add_Sub_Admin_Admin_Level({Key? key}) : super(key: key);

  @override
  State<Add_Sub_Admin_Admin_Level> createState() => _Add_Sub_Admin_Admin_LevelState();
}
...
class _Add_Sub_Admin_Admin_LevelState extends State<Add_Sub_Admin_Admin_Level> {
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        await logger.logActivity(currentUserId, "Added a New Sub Admin", currentAdminName, currentAdminEmail, phone);
                        Navigator.of(context).pop();
                        // Optionally, you can navigate back or clear the form
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (c) => Admin_Panel_Access_3()),
                        );
                      },
                    ),
                  ],

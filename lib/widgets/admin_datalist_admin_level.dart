...
import 'package:sub_admin_panel/dashboard/Admin%20Panel%20Permissions/Admin_Panel.dart';


class AdminDataListAdminLevel extends StatefulWidget {
  const AdminDataListAdminLevel({Key? key}) : super(key: key);

  @override
  State<AdminDataListAdminLevel> createState() => _AdminDataListAdminLevelState();
}
...
class _AdminDataListAdminLevelState extends State<AdminDataListAdminLevel> {
          ...
          child: StreamBuilder(
            ...
            builder: (BuildContext context, snapshotData) {
              ...
              dataMap.forEach((key, value) {
                // Filter for sub-admins and exclude those with "Access 1"
                if (value["role"] == "Admin" && value["access"] != "Super Admin") {

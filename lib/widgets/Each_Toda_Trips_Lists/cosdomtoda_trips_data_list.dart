...
class COSDOMTODATripsDataList extends StatefulWidget {
  const COSDOMTODATripsDataList({super.key});

  @override
  State<COSDOMTODATripsDataList> createState() => _COSDOMTODATripsDataListState();
}

class _COSDOMTODATripsDataListState extends State<COSDOMTODATripsDataList> {

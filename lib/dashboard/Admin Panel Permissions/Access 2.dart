...
import 'package:sub_admin_panel/pages/admin_page_access_2.dart';
import 'package:sub_admin_panel/pages/sub_admin_page_access_2.dart';
...
class Admin_Panel_Access_2 extends StatefulWidget {

  const Admin_Panel_Access_2({super.key});

  @override

  State<Admin_Panel_Access_2> createState() => _Admin_Panel_Access_2State();
}

class _Admin_Panel_Access_2State extends State<Admin_Panel_Access_2>
...

{
  ...
  sendAdminTo(selectedPage){
    switch(selectedPage.route)
    {
      ...
      case AdminPage.Id:
        setState(() {
          chosenScreen = AdminPageAccess2();
        });
        break;

      case SubAdminPageAccess2.Id:
        setState(() {
          chosenScreen = const SubAdminPageAccess2();
        });
        break;
    ...
    return AdminScaffold(
      ...
      sideBar: SideBar(
        items:  const[
          ...
          AdminMenuItem(
            title: "Admin List",
            route:  AdminPageAccess2.Id,
            icon: CupertinoIcons.person,
          ),
          AdminMenuItem(
            title: "Sub Admin List",
            route:  SubAdminPageAccess2.Id,

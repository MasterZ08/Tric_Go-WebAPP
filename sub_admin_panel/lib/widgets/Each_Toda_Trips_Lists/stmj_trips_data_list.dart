...
class STMJDTripsDataList extends StatefulWidget {
  const STMJDTripsDataList({super.key});

  @override
  State<STMJDTripsDataList> createState() => _STMJDTripsDataListState();
}

class _STMJDTripsDataListState extends State<STMJDTripsDataList> {

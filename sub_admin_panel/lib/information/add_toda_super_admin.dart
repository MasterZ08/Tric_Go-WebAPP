...
class Add_TODA_Super_Admin extends StatefulWidget {
  const Add_TODA_Super_Admin({Key? key}) : super(key: key);

  @override
  State<Add_TODA_Super_Admin> createState() => _Add_TODA_Super_AdminState();
}
...
class _Add_TODA_Super_AdminState extends State<Add_TODA_Super_Admin> {
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(builder: (context) => Super_Admin_Panel()),
                          (route) => false,
                    );

...
import 'package:sub_admin_panel/pages/admin_page_access_4.dart';
import 'package:sub_admin_panel/pages/sub_admin_page_access_4.dart';
...
class Admin_Panel_Access_4 extends StatefulWidget {

  const Admin_Panel_Access_4({super.key});

  @override

  State<Admin_Panel_Access_4> createState() => _Admin_Panel_Access_4State();
}

class _Admin_Panel_Access_4State extends State<Admin_Panel_Access_4>
...

{
  ...
  sendAdminTo(selectedPage){
    switch(selectedPage.route)
    {
      ...
      case AdminPageAccess4.Id:
        setState(() {
          chosenScreen = AdminPageAccess4();
        });
        break;

      case SubAdminPageAccess4.Id:
        setState(() {
          chosenScreen = SubAdminPageAccess4();
        });
        break;
    ...
    return AdminScaffold(
      ...
      sideBar: SideBar(
        items:  const[
          ...
          AdminMenuItem(
            title: "Admin List",
            route:  AdminPageAccess4.Id,
            icon: CupertinoIcons.person,
          ),
          AdminMenuItem(
            title: "Sub Admin List",
            route:  SubAdminPageAccess4.Id,

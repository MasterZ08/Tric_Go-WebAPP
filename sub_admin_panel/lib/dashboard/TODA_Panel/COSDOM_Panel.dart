...
import 'package:sub_admin_panel/pages/Queue%20List%20TODA/cosdom_driver_queue.dart';
...
import '../../pages/Each_TODA_Trips_List/cosdomtoda_trips_page.dart';
...
class COSDOM_Panel extends StatefulWidget {

  const COSDOM_Panel({super.key});

  @override

  State<COSDOM_Panel> createState() => _COSDOM_PanelState();
}

class _COSDOM_PanelState extends State<COSDOM_Panel>
...

{
  ...
  sendAdminTo(selectedPage){
    switch(selectedPage.route)
    {
      ...
      case COSDOMTODADriversPage.Id:
        setState(() {
          chosenScreen = COSDOMTODADriversPage();
        });
        break;

      case COSDOMTODATripsPage.Id:
        setState(() {
          chosenScreen = COSDOMTODATripsPage();
        });
        break;
      ...
      case COSDOMTODADriversQueuePage.Id:
        setState(() {
          chosenScreen = COSDOMTODADriversQueuePage();
        });
        break;
    ...
    return AdminScaffold(
      ...
      sideBar: SideBar(
        items:  const[
          ...
          AdminMenuItem(
            title: "Drivers List",
            route:  COSDOMTODADriversPage.Id,
            icon: CupertinoIcons.person_crop_rectangle,
          ),

          AdminMenuItem(
            title: "Trips",
            route:  COSDOMTODATripsPage.Id,
            icon: CupertinoIcons.location_fill,
          ),

          AdminMenuItem(
            title: "Queue List",
            route: COSDOMTODADriversQueuePage.Id,
